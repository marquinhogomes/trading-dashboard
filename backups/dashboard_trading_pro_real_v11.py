...
def render_positions_table():
    ...
    with col_posicoes:
        ...
        if not posicoes:
            ...
            if posicoes_formatted:
                # ==================================================================================
                # NOVA VERSÃO: TABELA COM BOTÕES DE AÇÃO INTEGRADOS
                # ==================================================================================
    ...
    with col_ordens:
        ...
        if not ordens_pendentes:
            ...
            if ordens_formatted:
                # ==================================================================================
                # NOVA VERSÃO: TABELA COM BOTÕES DE CANCELAMENTO INTEGRADOS
                # ==================================================================================
                            ...
                            <div style="padding: 8px; border-radius: 8px; border: 1px solid #ddd; margin-bottom: 8px;">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <div>
                                        ...
                                        | ⏱️ {ordem_data['Tempo Setup']} | ⏰ {ordem_data['Expira']}
                                    </div>
                                </div>
                            </div>
                            """, unsafe_allow_html=True)
    ...
    # ==================================================================================
    # COMENTÁRIO: BOTÕES DE AÇÃO AGORA INTEGRADOS NAS TABELAS ACIMA
    # ==================================================================================
    # Os botões de fechar posições e cancelar ordens agora estão diretamente 
    # nas linhas das respectivas tabelas para melhor usabilidade
