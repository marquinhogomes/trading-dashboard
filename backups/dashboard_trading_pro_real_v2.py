...
class TradingSystemReal:
    ...
    def __init__(self):
        ...
        self.dados_sistema = {
            ...
            "sharpe_ratio": 0.0,
            "ultimo_update": None
        }  # Mantém para compatibilidade, mas será sobrescrito pelo sistema integrado se disponível
        self.logs = []  # Mantém para compatibilidade, mas será sobrescrito pelo sistema integrado se disponível
        # Inicializar listas essenciais para evitar AttributeError
        self.trade_history = []
