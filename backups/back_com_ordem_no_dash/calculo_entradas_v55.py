...
inicia_pregao = 0                # Pregão oficial: 10h
finaliza_pregao = 23              # Pregão oficial: 17h (mantido)
...
finaliza_ordens = 23              # Para de enviar NOVAS ordens às 15h (mantido)
ajusta_ordens = 23                # Ajustes às 15h (mantido)
ajusta_ordens_minuto = 10         # Ajustes às 15:10h (mantido)

# Horários específicos para diferentes tipos de ajuste
horario_ajuste_stops = 23         # 15h - Ajustar stops de posições abertas
horario_remove_pendentes = 23     # 15h - Remover ordens pendentes (15:20h)
horario_fechamento_total = 23     # 16h - Fechamento forçado (16:01h)

# NOVO: Janelas de tempo para diferentes atividades
JANELA_ANALISE_POSICOES = (0, 23)      # 10h-17h: Monitorar posições
JANELA_NOVAS_OPERACOES = (0, 23)       # 10h-16h: Aceitar novas operações
JANELA_AJUSTES_DINAMICOS = (0, 23)     # 10h-17h: Ajustes dinâmicos
JANELA_BREAK_EVEN = (0, 23)            # 10h-17h: Break-even automático
