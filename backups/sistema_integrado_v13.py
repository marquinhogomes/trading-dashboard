    ...
    def aplicar_parametros_dinamicos(self):
        ...
        try:
            ...
            if verificar_parametros_alterados():
                ...
                # Log das mudanças
                self.log(f"✅ NOVOS PARÂMETROS APLICADOS NO SISTEMA INTEGRADO:")
                ...
                self.log(f"   • Limite prejuízo: R$ {self.limite_prejuizo}")
                self.log(f"   • P-value cointegração: {self.pvalor}")
                ...
                for chave, valor_novo in valores_novos.items():
                    valor_antigo = valores_antigos[chave]
                ...
                # Marca como aplicado
                aplicar_parametros_sistema()
                self.log("✅ Parâmetros marcados como aplicados no sistema integrado")
