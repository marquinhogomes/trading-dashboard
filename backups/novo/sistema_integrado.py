...
class SistemaIntegrado:
            ...
            if posicoes_pendentes:
                for ordem in posicoes_pendentes:
                    if ordem.magic == magic:
                        symbol = ordem.symbol                        # Prepara requisição de cancelamento
                        request = {
    ...
    def converter_ordem_pendente_para_mercado(self, magic, posicao, ordens_pendentes, independe_atual):
        ...
        try:
            for ordem in ordens_pendentes:
                ...
                volume = posicao.volume  # Usa mesmo volume da posição dependente                # Prepara ordem a mercado
                ordem_mercado = {
                    "action": mt5.TRADE_ACTION_DEAL,
    ...
    def ajustar_tp_60_porcento(self, pos, symbol_info_tick):
        ...
        try:
            ...
            novo_sl = round(novo_sl, digits)            # Enviar modificação
            request_modificacao = {
    ...
    def cancelar_ordem_pendente(self, ordem):
        ...
        try:
            request = {
                ...
                "symbol": ordem.symbol,
                "magic": ordem.magic,
                "comment": "Cancelamento_sistema_integrado",
            }
