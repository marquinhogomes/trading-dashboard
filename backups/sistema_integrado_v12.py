...
class SistemaIntegrado:
    ...
    def __init__(self):
        ...
        # **ETAPA 1: Inicializa as threads do sistema principal automaticamente**
        print("[DEBUG] SistemaIntegrado.__init__ INICIADO")
        self.iniciar_threads_apenas()
        print("[DEBUG] SistemaIntegrado.__init__ FINALIZADO")
    ...
    # ===== MÉTODOS DE CONTROLE DA THREAD DE ANÁLISE (DASHBOARD) =====
