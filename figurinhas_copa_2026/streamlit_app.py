...
# Ordem do álbum, preservando a sequência corrigida.
SECTIONS = [
    ["FWC", "Abertura / Especiais", "🏆", 20, "intro"],
    ["MEX", "México", "🇲🇽", 20, "team"],
    ["RSA", "África do Sul", "🇿🇦", 20, "team"],
    ["KOR", "Coreia do Sul", "🇰🇷", 20, "team"],
    ["CZE", "Tchéquia", "🇨🇿", 20, "team"],
    ["CAN", "Canadá", "🇨🇦", 20, "team"],
    ["BIH", "Bósnia e Herzegovina", "🇧🇦", 20, "team"],
    ["QAT", "Catar", "🇶🇦", 20, "team"],
    ["SUI", "Suíça", "🇨🇭", 20, "team"],
    ["BRA", "Brasil", "🇧🇷", 20, "team"],
    ["MAR", "Marrocos", "🇲🇦", 20, "team"],
    ["HAI", "Haiti", "🇭🇹", 20, "team"],
    ["SCO", "Escócia", "🏴", 20, "team"],
    ["USA", "Estados Unidos", "🇺🇸", 20, "team"],
    ["PAR", "Paraguai", "🇵🇾", 20, "team"],
    ["AUS", "Austrália", "🇦🇺", 20, "team"],
    ["TUR", "Turquia", "🇹🇷", 20, "team"],
    ["GER", "Alemanha", "🇩🇪", 20, "team"],
    ["CUW", "Curaçao", "🇨🇼", 20, "team"],
    ["CIV", "Costa do Marfim", "🇨🇮", 20, "team"],
    ["ECU", "Equador", "🇪🇨", 20, "team"],
    ["NED", "Países Baixos", "🇳🇱", 20, "team"],
    ["JPN", "Japão", "🇯🇵", 20, "team"],
    ["SWE", "Suécia", "🇸🇪", 20, "team"],
    ["TUN", "Tunísia", "🇹🇳", 20, "team"],
    ["BEL", "Bélgica", "🇧🇪", 20, "team"],
    ["EGY", "Egito", "🇪🇬", 20, "team"],
    ["IRN", "Irã", "🇮🇷", 20, "team"],
    ["NZL", "Nova Zelândia", "🇳🇿", 20, "team"],
    ["ESP", "Espanha", "🇪🇸", 20, "team"],
    ["CPV", "Cabo Verde", "🇨🇻", 20, "team"],
    ["KSA", "Arábia Saudita", "🇸🇦", 20, "team"],
    ["URU", "Uruguai", "🇺🇾", 20, "team"],
    ["FRA", "França", "🇫🇷", 20, "team"],
    ["SEN", "Senegal", "🇸🇳", 20, "team"],
    ["IRQ", "Iraque", "🇮🇶", 20, "team"],
    ["NOR", "Noruega", "🇳🇴", 20, "team"],
    ["ARG", "Argentina", "🇦🇷", 20, "team"],
    ["ALG", "Argélia", "🇩🇿", 20, "team"],
    ["AUT", "Áustria", "🇦🇹", 20, "team"],
    ["JOR", "Jordânia", "🇯🇴", 20, "team"],
    ["POR", "Portugal", "🇵🇹", 20, "team"],
    ["COD", "RD Congo", "🇨🇩", 20, "team"],
    ["UZB", "Uzbequistão", "🇺🇿", 20, "team"],
    ["COL", "Colômbia", "🇨🇴", 20, "team"],
    ["ENG", "Inglaterra", "🏴", 20, "team"],
    ["CRO", "Croácia", "🇭🇷", 20, "team"],
    ["GHA", "Gana", "🇬🇭", 20, "team"],
    ["PAN", "Panamá", "🇵🇦", 20, "team"],
]
...
def load_initial_owned_text() -> str:
    """Lê o JSON/lista inicial já existente no repositório, sem importar o app antigo."""
...
var LEGACY_KEYS=["controle_figurinhas_copa_2026_html_streamlit_v1","controle_figurinhas_copa_2026_html_streamlit_v2_album_order","controle_figurinhas_copa_2026_html_streamlit_v1_fixed_order","controle_figurinhas_copa_2026_v3_embutido"];
var albumSections=__SECTIONS__.map(function(x){return{code:x[0],name:x[1],emoji:x[2],count:x[3],kind:x[4]};});
...
with st.sidebar:
    ...
    st.info("Versão HTML completa com ordem corrigida e progresso anterior recuperado.")
