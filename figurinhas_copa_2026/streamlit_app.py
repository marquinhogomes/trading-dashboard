...
# Ordem do álbum: inferida pela sequência do backup/álbum enviado.
# A opção "Ordem do álbum" no HTML usa exatamente esta sequência.
SECTIONS = [
...
<script>
(function(){"use strict";
var STORAGE_KEY="controle_figurinhas_copa_2026_html_streamlit_v2_album_order";
...
with st.sidebar:
    ...
    st.info("Versão HTML completa com ordem do álbum corrigida.")
